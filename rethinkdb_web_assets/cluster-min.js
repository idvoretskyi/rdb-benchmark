...
OptionsView = (function(_super) {
  ...
  function OptionsView() {
    ...
    this.render = __bind(this.render, this);    _ref = OptionsView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  OptionsView.prototype.render = function() {
    ...
    this.$el.html(this.template({
      check_update: ((_ref1 = window.localStorage) != null ? _ref1.check_updates : void 0) != null ? JSON.parse(window.localStorage.check_updates) : true,
...
AlertUpdates = (function(_super) {
  ...
  function AlertUpdates() {
    ...
    this.initialize = __bind(this.initialize, this);    _ref1 = AlertUpdates.__super__.constructor.apply(this, arguments);
    return _ref1;
  }
...
Settings = (function(_super) {
  ...
  function Settings() {
    ...
    this.close = __bind(this.close, this);    _ref2 = Settings.__super__.constructor.apply(this, arguments);
    return _ref2;
  }
  ...
  Settings.prototype.initialize = function(args) {
    ...
    if (((_ref3 = window.localStorage) != null ? _ref3.check_updates : void 0) != null) {
...
IsDisconnected = (function(_super) {
  ...
  function IsDisconnected() {
    ...
    this.render = __bind(this.render, this);
    this.initialize = __bind(this.initialize, this);    _ref3 = IsDisconnected.__super__.constructor.apply(this, arguments);
    return _ref3;
  }
...
module('UIComponents', function() {
  ...
  this.AbstractModal = (function(_super) {
    ...
    function AbstractModal() {
      ...
      this.render = __bind(this.render, this);      _ref4 = AbstractModal.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  this.ConfirmationDialogModal = (function(_super) {
    ...
    function ConfirmationDialogModal() {
      _ref5 = ConfirmationDialogModal.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  return this.RenameItemModal = (function(_super) {
    ...
    function RenameItemModal() {
      _ref6 = RenameItemModal.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
    ...
    RenameItemModal.prototype.on_submit = function() {
      var database, datacenter, machine, namespace, no_error, template_error, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref10, _ref7, _ref8, _ref9;
      ...
      if (this.item_type === 'namespace') {
        if (this.formdata.new_name === '') {
          ...
          _ref7 = namespaces.models;
          for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
            namespace = _ref7[_i];
            if (namespace.get('name').toLowerCase() === this.formdata.new_name.toLowerCase()) {
              no_error = false;
              $('.alert_modal').html(this.error_template({
      ...
      if (this.item_type === 'database') {
        if (this.formdata.new_name === '') {
          ...
          _ref8 = databases.models;
          for (_j = 0, _len1 = _ref8.length; _j < _len1; _j++) {
            database = _ref8[_j];
            if (database.get('name').toLowerCase() === this.formdata.new_name.toLowerCase()) {
              no_error = false;
              $('.alert_modal').html(this.error_template({
...
module('UIComponents', function() {
  ...
  this.AbstractList = (function(_super) {
    ...
    function AbstractList() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref4 = AbstractList.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
    ...
    AbstractList.prototype.render = function() {
      var view, _i, _len, _ref5;

      if (this.sort != null) {
        this.element_views.sort(this.sort);
      }
      this.$el.html(this.template({}));
      _ref5 = this.element_views;
      for (_i = 0, _len = _ref5.length; _i < _len; _i++) {
        view = _ref5[_i];
    ...
    AbstractList.prototype.reset_element_views = function() {
      var model, view, _i, _j, _len, _len1, _ref5, _ref6, _results;
    ...
    AbstractList.prototype.get_selected_elements = function() {
      var selected_elements, view, _i, _len, _ref5;
    ...
    AbstractList.prototype.destroy = function() {
      var view, _i, _len, _ref5, _results;
  ...
  this.CheckboxListElement = (function(_super) {
    ...
    function CheckboxListElement() {
      ...
      this.render = __bind(this.render, this);      _ref5 = CheckboxListElement.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  return this.CollapsibleListElement = (function(_super) {
    ...
    function CollapsibleListElement() {
      ...
      this.render = __bind(this.render, this);      _ref6 = CollapsibleListElement.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
    ...
    CollapsibleListElement.prototype.swap_divs = function() {
      var $control, div, _i, _len, _ref7, _results;
...
module('UIComponents', function() {
  ...
  return this.OperationProgressBar = (function(_super) {
    ...
    function OperationProgressBar() {
      ...
      this.render = __bind(this.render, this);      _ref4 = OperationProgressBar.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
...
module('DatabaseView', function() {
  ...
  this.NotFound = (function(_super) {
    ...
    function NotFound() {
      this.render = __bind(this.render, this);
      this.initialize = __bind(this.initialize, this);      _ref4 = NotFound.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  this.Container = (function(_super) {
    ...
    function Container() {
      ...
      this.render = __bind(this.render, this);
      this.check_if_still_exists = __bind(this.check_if_still_exists, this);      _ref5 = Container.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
    ...
    Container.prototype.check_if_still_exists = function() {
      var database, exist, _i, _len, _ref6;

      exist = false;
      _ref6 = databases.models;
  ...
  this.Title = (function(_super) {
    ...
    function Title() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref6 = Title.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  this.Profile = (function(_super) {
    ...
    function Profile() {
      this.destroy = __bind(this.destroy, this);
      this.render = __bind(this.render, this);
      this.initialize = __bind(this.initialize, this);      _ref7 = Profile.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
    ...
    Profile.prototype.render = function() {
      var data, datacenter_id, datacenters_id, datacenters_working, namespace, namespace_status, _i, _len, _ref8;
  ...
  this.RemoveDatabaseModal = (function(_super) {
    ...
    function RemoveDatabaseModal() {
      this.on_success = __bind(this.on_success, this);
      this.on_submit = __bind(this.on_submit, this);      _ref8 = RemoveDatabaseModal.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
    ...
    RemoveDatabaseModal.prototype.on_submit = function() {
      var namespace, post_data, _i, _len, _ref9;
    ...
    RemoveDatabaseModal.prototype.on_success = function(response) {
      var id, namespace, namespace_id_to_remove, _i, _j, _len, _len1, _ref9;
  ...
  return this.NamespaceList = (function(_super) {
    ...
    function NamespaceList() {
      this.destroy = __bind(this.destroy, this);
      this.render = __bind(this.render, this);
      this.initialize = __bind(this.initialize, this);      _ref9 = NamespaceList.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
...
module('NamespaceView', function() {
  var _ref10, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
  ...
  this.DatabaseList = (function(_super) {
    ...
    function DatabaseList() {
      ...
      this.render = __bind(this.render, this);
      this.update_button_create_namespace = __bind(this.update_button_create_namespace, this);      _ref4 = DatabaseList.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  this.DatabaseListElement = (function(_super) {
    ...
    function DatabaseListElement() {
      ...
      this.render = __bind(this.render, this);      _ref5 = DatabaseListElement.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  this.NamespaceList = (function(_super) {
    ...
    function NamespaceList() {
      ...
      this.add_namespace = __bind(this.add_namespace, this);
      this.add_element = __bind(this.add_element, this);
      this.initialize = __bind(this.initialize, this);      _ref6 = NamespaceList.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
    ...
    NamespaceList.prototype.register_namespace_callbacks = function(callbacks) {
      var namespace_list_element, _i, _len, _ref7, _results;

      this.callbacks = callbacks;
      _ref7 = this.element_views;
      _results = [];
      for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
        namespace_list_element = _ref7[_i];
    ...
    NamespaceList.prototype.bind_callbacks_to_namespace = function(namespace_list_element) {
      ...
      return namespace_list_element.on('selected', function() {
        var callback, _i, _len, _ref7, _results;

        _ref7 = _this.callbacks;
        _results = [];
        for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
          callback = _ref7[_i];
  ...
  this.NamespaceListElement = (function(_super) {
    ...
    function NamespaceListElement() {
      this.destroy = __bind(this.destroy, this);
      this.render = __bind(this.render, this);
      this.json_for_template = __bind(this.json_for_template, this);      _ref7 = NamespaceListElement.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
  ...
  this.AddDatabaseModal = (function(_super) {
    ...
    function AddDatabaseModal() {
      this.on_success = __bind(this.on_success, this);      _ref8 = AddDatabaseModal.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
    ...
    AddDatabaseModal.prototype.on_submit = function() {
      var database, no_error, _i, _len, _ref9;
      ...
      if (this.formdata.name === '') {
        ...
        _ref9 = databases.models;
        for (_i = 0, _len = _ref9.length; _i < _len; _i++) {
          database = _ref9[_i];
          if (database.get('name').toLowerCase() === this.formdata.name.toLowerCase()) {
            no_error = false;
            $('.alert_modal').html(this.error_template({
              database_exists: true
            }));
  ...
  this.AddNamespaceModal = (function(_super) {
    ...
    function AddNamespaceModal() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref9 = AddNamespaceModal.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
    ...
    AddNamespaceModal.prototype.render = function() {
      var datacenter, machine, ordered_datacenters, slice_index, _i, _j, _k, _len, _len1, _len2, _ref10, _ref11;

      log_render('(rendering) add namespace dialog');
      _ref10 = datacenters.models;
      for (_i = 0, _len = _ref10.length; _i < _len; _i++) {
        datacenter = _ref10[_i];
        datacenter.set('num_machines', 0);
      }
      _ref11 = machines.models;
    ...
    AddNamespaceModal.prototype.on_submit = function() {
      var ack, cache_size_int, formdata, input_error, namespace, template_error, _i, _len, _ref10;
      ...
      if (formdata.name === '') {
        ...
        _ref10 = namespaces.models;
        for (_i = 0, _len = _ref10.length; _i < _len; _i++) {
          namespace = _ref10[_i];
          if (namespace.get('name').toLowerCase() === formdata.name.toLowerCase() && namespace.get('database').toLowerCase() === formdata.database.toLowerCase()) {
            input_error = true;
  ...
  return this.RemoveNamespaceModal = (function(_super) {
    ...
    function RemoveNamespaceModal() {
      this.ton_error = __bind(this.ton_error, this);      _ref10 = RemoveNamespaceModal.__super__.constructor.apply(this, arguments);
      return _ref10;
    }
    ...
    RemoveNamespaceModal.prototype.on_submit = function() {
      var data, namespace, _i, _len, _ref11;

      RemoveNamespaceModal.__super__.on_submit.apply(this, arguments);
      data = {};
      _ref11 = this.namespaces_to_delete;
    ...
    RemoveNamespaceModal.prototype.on_success = function(response) {
      var deleted_namespaces, namespace, _i, _len, _ref11;
...
module('NamespaceView', function() {
  ...
  this.Replicas = (function(_super) {
    ...
    function Replicas() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref4 = Replicas.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
    ...
    Replicas.prototype.render_status = function(progress_bar_info) {
      var activities, activity, activity_id, backfilling_info, blueprint, expected_num_replicas, expected_status, found_shard, machine_id, num_replicas, num_replicas_not_ready, num_replicas_ready, role, shard, shard_ready, _ref5, _ref6, _ref7;
      ...
      for (machine_id in blueprint) {
        for (shard in blueprint[machine_id]) {
          ...
          activities = (_ref5 = directory.get(machine_id)) != null ? (_ref6 = _ref5.get(this.model.get('protocol') + '_namespaces')) != null ? (_ref7 = _ref6['reactor_bcards'][this.model.get('id')]) != null ? _ref7['activity_map'] : void 0 : void 0 : void 0;
          if (activities != null) {
    ...
    Replicas.prototype.render_list = function() {
      var datacenter, found_active, i, _i, _j, _len, _len1, _ref5, _ref6,
        _this = this;
      ...
      if (this.active_datacenter_id != null) {
        _ref5 = this.ordered_datacenters;
      ...
      if (found_active === false) {
        if (this.model.get('primary_uuid') === universe_datacenter.get('id')) {
          ...
          _ref6 = this.ordered_datacenters;
  ...
  this.DatacenterReplicas = (function(_super) {
    ...
    function DatacenterReplicas() {
      ...
      this.initialize = __bind(this.initialize, this);
      this.keypress_replicas_acks = __bind(this.keypress_replicas_acks, this);      _ref5 = DatacenterReplicas.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  return this.PrimaryDatacenter = (function(_super) {
    ...
    function PrimaryDatacenter() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref6 = PrimaryDatacenter.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
    ...
    PrimaryDatacenter.prototype.on_success_off = function() {
      var data_to_set, dc, value, _ref7;

      data_to_set = this.data_cached;
      _ref7 = this.model.get('replica_affinities');
      for (dc in _ref7) {
        value = _ref7[dc];
    ...
    PrimaryDatacenter.prototype.set_new_primary = function(new_primary, current_primary, on_success, on_error) {
      var data, new_ack, new_replica_affinities, primary_pinnings, shard, _i, _len, _ref7;

      primary_pinnings = {};
      _ref7 = this.model.get('primary_pinnings');
      for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
        shard = _ref7[_i];
        primary_pinnings[shard] = null;
      }
...
module('NamespaceView', function() {
  var MAX_SHARD_COUNT, _ref4, _ref5;
  ...
  this.Sharding = (function(_super) {
    ...
    function Sharding() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref4 = Sharding.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
    ...
    Sharding.prototype.check_shards_changes = function() {
      var current_count, data, distr_keys, error_msg, i, key, new_num_shards, no_more_splits, rows_per_shard, shard_set, splitIndex, split_points, total_rows, _i, _j, _len, _ref5,
        _this = this;
      ...
      shard_set = [];
      for (splitIndex = _j = 0, _ref5 = split_points.length - 2; 0 <= _ref5 ? _j <= _ref5 : _j >= _ref5; splitIndex = 0 <= _ref5 ? ++_j : --_j) {
    ...
    Sharding.prototype.shard_table = function(event) {
      var data, datacenter_id, new_replicas, replicas_length, shard, _i, _len, _ref5;
    ...
    Sharding.prototype.render_status = function(progress_bar_info) {
      var activities, activity, activity_id, blueprint, datacenter_id, expected_status, machine, machine_id, master, num_shards, num_shards_in_blueprint, num_shards_not_ready, num_shards_ready, role, shard, shards, _i, _j, _len, _len1, _ref5, _ref6, _ref7, _ref8, _ref9;
      ...
      for (machine_id in blueprint) {
        for (shard in blueprint[machine_id]) {
          ...
          activities = (_ref6 = directory.get(machine_id)) != null ? (_ref7 = _ref6.get(this.model.get('protocol') + '_namespaces')) != null ? (_ref8 = _ref7['reactor_bcards'][this.model.get('id')]) != null ? _ref8['activity_map'] : void 0 : void 0 : void 0;
          if (activities != null) {
            for (activity_id in activities) {
              activity = activities[activity_id];
              if (activity[0] === shard) {
    ...
    Sharding.prototype.check_can_change_shards = function() {
      var can_change_shards_now, issue, reasons_cannot_shard, _i, _len, _ref5;
    ...
    Sharding.prototype.render_data_repartition = function() {
      var axe_legend, bar_width, extra_data, margin_bar, margin_height, margin_width, margin_width_inner, max_keys, min_keys, min_margin_width_inner, new_shard, shard, shards, svg, svg_height, svg_width, total_keys, width_of_all_bars, y, _i, _len, _ref5;
  ...
  return this.ChangeShardsModal = (function(_super) {
    ...
    function ChangeShardsModal() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref5 = ChangeShardsModal.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
...
module('NamespaceView', function() {
  ...
  return this.ServerAssignments = (function(_super) {
    ...
    function ServerAssignments() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref4 = ServerAssignments.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
    ...
    ServerAssignments.prototype.get_shards = function(id, role_requested) {
      var keys, machine_id, peer_roles, role, shard, shards, _ref5;

      shards = [];
      _ref5 = this.model.get('blueprint').peers_roles;
      for (machine_id in _ref5) {
        peer_roles = _ref5[machine_id];
        if (machine_id === id) {
    ...
    ServerAssignments.prototype.render = function() {
      var data, data_grouped_by_datacenter, data_on_machines, datacenters_for_table, keys, machine, machine_id, peer_roles, role, shard, _ref5;
...
module('NamespaceView', function() {
  ...
  this.NotFound = (function(_super) {
    ...
    function NotFound() {
      this.render = __bind(this.render, this);      _ref4 = NotFound.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  this.Container = (function(_super) {
    ...
    Container.prototype.check_if_still_exists = function() {
      var exist, namespace, _i, _len, _ref6;

      exist = false;
      _ref6 = namespaces.models;
      for (_i = 0, _len = _ref6.length; _i < _len; _i++) {
        namespace = _ref6[_i];
  ...
  this.Title = (function(_super) {
    ...
    function Title() {
      this.destroy = __bind(this.destroy, this);
      this.render = __bind(this.render, this);
      this.update = __bind(this.update, this);      _ref6 = Title.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  this.Profile = (function(_super) {
    ...
    function Profile() {
      this.destroy = __bind(this.destroy, this);
      this.render = __bind(this.render, this);      _ref7 = Profile.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
    ...
    Profile.prototype.render = function() {
      var data, key, machine, _i, _len, _ref8;
  ...
  return this.SecondaryIndexesView = (function(_super) {
    ...
    function SecondaryIndexesView() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref8 = SecondaryIndexesView.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
    ...
    SecondaryIndexesView.prototype.interval = 60 * 1000;
    ...
    SecondaryIndexesView.prototype.set_interval_get_indexes = function() {
      this.get_indexes();
      return this.interval = setInterval(this.get_indexes, this.interval);
    };

    SecondaryIndexesView.prototype.get_indexes = function() {
    ...
    SecondaryIndexesView.prototype.hide_alert = function(event) {
      ...
      if ((event != null) && (((_ref9 = this.$(event.target)) != null ? _ref9.data('name') : void 0) != null)) {
        this.deleting_secondary_index = null;
      }
      event.preventDefault();
...
module('ServerView', function() {
  ...
  this.DatacenterList = (function(_super) {
    ...
    function DatacenterList() {
      ...
      this.render = __bind(this.render, this);
      this.initialize = __bind(this.initialize, this);      _ref4 = DatacenterList.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  this.DatacenterListElement = (function(_super) {
    ...
    function DatacenterListElement() {
      ...
      this.render_summary = __bind(this.render_summary, this);
      this.render = __bind(this.render, this);      _ref5 = DatacenterListElement.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
    ...
    DatacenterListElement.prototype.render_summary = function() {
      var json, machine_active_for_namespace, machine_uuid, namespace, peer_role, role, shard, _i, _len, _namespaces, _ref6, _ref7, _ref8;
      ...
      for (_i = 0, _len = _ref6.length; _i < _len; _i++) {
        namespace = _ref6[_i];
        _ref7 = namespace.get('blueprint').peers_roles;
        for (machine_uuid in _ref7) {
          peer_role = _ref7[machine_uuid];
          if (((_ref8 = machines.get(machine_uuid)) != null ? _ref8.get('datacenter_uuid') : void 0) && machines.get(machine_uuid).get('datacenter_uuid') === this.model.get('id')) {
  ...
  this.MachineList = (function(_super) {
    ...
    function MachineList() {
      ...
      this.get_selected_elements = __bind(this.get_selected_elements, this);
      this.get_length = __bind(this.get_length, this);      _ref6 = MachineList.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
    ...
    MachineList.prototype.get_selected_elements = function() {
      var selected_elements, view, _i, _len, _ref7;

      selected_elements = [];
      _ref7 = this.machine_views;
      for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
        view = _ref7[_i];
        if (view.selected) {
          selected_elements.push(view.model);
    ...
    MachineList.prototype.check_machines = function() {
      var i, machine, machine_id, machine_view, need_render, _i, _j, _len, _len1, _ref7, _ref8, _ref9;

      need_render = false;
      _ref7 = machines.models;
      for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
        machine = _ref7[_i];
      ...
      _ref8 = this.machines_in_datacenter;
      for (machine_id in _ref8) {
        machine = _ref8[machine_id];
        if ((machines.get(machine_id) == null) || machines.get(machine_id).get('datacenter_uuid') !== this.datacenter_uuid) {
          ...
          _ref9 = this.machine_views;
          for (i = _j = 0, _len1 = _ref9.length; _j < _len1; i = ++_j) {
            machine_view = _ref9[i];
    ...
    MachineList.prototype.render = function() {
      var machine_view, _i, _len, _ref7;
    ...
    MachineList.prototype.register_machine_callbacks = function(callbacks) {
      var machine_list_element, _i, _len, _ref7, _results;

      this.callbacks = callbacks;
      _ref7 = this.machine_views;
      _results = [];
      for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
        machine_list_element = _ref7[_i];
  ...
  this.MachineListElement = (function(_super) {
    ...
    function MachineListElement() {
      ...
      this.json_for_template = __bind(this.json_for_template, this);
      this.initialize = __bind(this.initialize, this);      _ref7 = MachineListElement.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
    ...
    MachineListElement.prototype.render_info = function() {
      var data, machine_active_for_namespace, machine_uuid, namespace, peer_role, role, shard, _i, _len, _ref8, _ref9;
      ...
      for (_i = 0, _len = _ref8.length; _i < _len; _i++) {
        namespace = _ref8[_i];
        _ref9 = namespace.get('blueprint').peers_roles;
        for (machine_uuid in _ref9) {
          peer_role = _ref9[machine_uuid];
  ...
  this.UnassignedMachinesListElement = (function(_super) {
    ...
    function UnassignedMachinesListElement() {
      this.destroy = __bind(this.destroy, this);
      this.register_machine_callbacks = __bind(this.register_machine_callbacks, this);
      this.render = __bind(this.render, this);      _ref8 = UnassignedMachinesListElement.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  this.AddDatacenterModal = (function(_super) {
    ...
    function AddDatacenterModal() {
      _ref9 = AddDatacenterModal.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
    ...
    AddDatacenterModal.prototype.on_submit = function() {
      var datacenter, no_error, _i, _len, _ref10;
  ...
  this.RemoveDatacenterModal = (function(_super) {
    ...
    function RemoveDatacenterModal() {
      ...
      this.unassign_machines_in_datacenter = __bind(this.unassign_machines_in_datacenter, this);      _ref10 = RemoveDatacenterModal.__super__.constructor.apply(this, arguments);
      return _ref10;
    }
    ...
    RemoveDatacenterModal.prototype.remove_responsabilities = function() {
      var namespace, namespaces_to_update, new_ack_expectations, new_replica_affinities, _i, _len, _ref11;

      namespaces_to_update = {};
      _ref11 = namespaces.models;
      for (_i = 0, _len = _ref11.length; _i < _len; _i++) {
        namespace = _ref11[_i];
  ...
  return this.SetDatacenterModal = (function(_super) {
    ...
    function SetDatacenterModal() {
      this.on_success = __bind(this.on_success, this);      _ref11 = SetDatacenterModal.__super__.constructor.apply(this, arguments);
      return _ref11;
    }
    ...
    SetDatacenterModal.prototype.render = function(_machines_list) {
      var data, datacenter, machine, new_data, warnings_by_machines, _i, _len, _ref12;
      ...
      data = {
        ...
        datacenters: (function() {
          ...
          _ref12 = datacenters.models;
          _results = [];
          for (_i = 0, _len = _ref12.length; _i < _len; _i++) {
            datacenter = _ref12[_i];
...
module('MachineView', function() {
  ...
  this.Container = (function(_super) {
    ...
    function Container() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref5 = Container.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
    ...
    Container.prototype.check_if_still_exists = function() {
      var exist, machine, _i, _len, _ref6;

      exist = false;
      _ref6 = machines.models;
      for (_i = 0, _len = _ref6.length; _i < _len; _i++) {
        machine = _ref6[_i];
  ...
  this.UnassignModal = (function(_super) {
    ...
    function UnassignModal() {
      this.on_success = __bind(this.on_success, this);
      this.on_submit = __bind(this.on_submit, this);
      this.render = __bind(this.render, this);      _ref8 = UnassignModal.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  return this.Data = (function(_super) {
    ...
    function Data() {
      this.destroy = __bind(this.destroy, this);
      this.render = __bind(this.render, this);
      this.initialize = __bind(this.initialize, this);      _ref9 = Data.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
    ...
    Data.prototype.render = function() {
      ...
      data_by_namespace = [];
      namespaces.each(function(namespace) {
        var json_shard, keys, machine_id, ns, peer_roles, role, shard, _ref10;
        ...
        _ref10 = namespace.get('blueprint').peers_roles;
        for (machine_id in _ref10) {
          peer_roles = _ref10[machine_id];
...
module('DatacenterView', function() {
  ...
  this.Container = (function(_super) {
    ...
    Container.prototype.initialize = function() {
      var filter, machine, _i, _len, _ref6;
    ...
    Container.prototype.check_if_still_exists = function() {
      var datacenter, exist, _i, _len, _ref6;

      exist = false;
      _ref6 = datacenters.models;
      for (_i = 0, _len = _ref6.length; _i < _len; _i++) {
        datacenter = _ref6[_i];
  ...
  this.Profile = (function(_super) {
    ...
    Profile.prototype.render = function() {
      var json, machine, machine_uuid, machines_in_datacenter, machines_returned, namespace, peer_roles, role, shard, shard_repr, stats, stats_up_to_date, status, total_replicas, total_shards, __shards, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _namespaces, _o, _ref10, _ref8, _ref9, _s, _shards,
        _this = this;
  ...
  this.MachineList = (function(_super) {
    ...
    function MachineList() {
      this.destroy = __bind(this.destroy, this);
      this.render = __bind(this.render, this);
      this.initialize = __bind(this.initialize, this);      _ref8 = MachineList.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
    ...
    MachineList.prototype.render = function() {
      ...
      namespaces.each(function(namespace) {
        var machine_id, peer_roles, role, shard, _ref9, _results;

        _ref9 = namespace.get('blueprint').peers_roles;
        _results = [];
        for (machine_id in _ref9) {
          peer_roles = _ref9[machine_id];
  ...
  return this.Data = (function(_super) {
    ...
    Data.prototype.render = function() {
      var json, keys, machine_uuid, machines_in_datacenter, namespace, peer_roles, role, shard, shard_repr, stats, __shards, _i, _j, _len, _len1, _namespaces, _ref10, _ref11, _shards,
        _this = this;
      ...
      for (_i = 0, _len = _ref10.length; _i < _len; _i++) {
        namespace = _ref10[_i];
        _shards = [];
        _ref11 = namespace.get('blueprint').peers_roles;
        for (machine_uuid in _ref11) {
          peer_roles = _ref11[machine_uuid];
          if (machines.get(machine_uuid).get('datacenter_uuid') === this.model.get('id')) {
            for (shard in peer_roles) {
              role = peer_roles[shard];
              if (role !== 'role_nothing') {
...
module('DashboardView', function() {
  ...
  this.Container = (function(_super) {
    ...
    function Container() {
      this.destroy = __bind(this.destroy, this);
      this.render = __bind(this.render, this);
      this.initialize = __bind(this.initialize, this);      _ref4 = Container.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
    ...
    Container.prototype.destroy = function() {
      ...
      return this.cluster_performance.destroy();
    };
  ...
  this.ClusterStatusAvailability = (function(_super) {
    ...
    function ClusterStatusAvailability() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref5 = ClusterStatusAvailability.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
    ...
    ClusterStatusAvailability.prototype.compute_data = function() {
      var blueprint, data, directory_by_namespaces, machine_id, machine_name, namespace, namespace_down, namespace_id, namespaces_down, namespaces_down_array, num_masters, num_masters_down, shard, value, _i, _len, _ref6, _ref7;
      ...
      for (_i = 0, _len = _ref6.length; _i < _len; _i++) {
        ...
        for (machine_id in blueprint) {
          machine_name = machine_name = (_ref7 = machines.get(machine_id)) != null ? _ref7.get('name') : void 0;
  ...
  this.ClusterStatusRedundancy = (function(_super) {
    ...
    function ClusterStatusRedundancy() {
      ...
      this.render = __bind(this.render, this);
      this.compute_data = __bind(this.compute_data, this);
      this.initialize = __bind(this.initialize, this);      _ref6 = ClusterStatusRedundancy.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
    ...
    ClusterStatusRedundancy.prototype.compute_data = function() {
      ...
      for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
        ...
        blueprint = namespace.get('blueprint').peers_roles;
        for (machine_id in blueprint) {
          machine_name = machine_name = (_ref8 = machines.get(machine_id)) != null ? _ref8.get('name') : void 0;
          if (machine_name == null) {
            machine_name = machine_id;
          }
          for (shard in blueprint[machine_id]) {
          ...
          for (datacenter_id in issue.get('replica_affinities')) {
            ...
            if (num_replicas > issue.get('actual_machines_in_datacenters')[datacenter_id]) {
              if (datacenter_id === universe_datacenter.get('id')) {
                ...
                datacenter_name = (_ref10 = datacenters.get(datacenter_id)) != null ? _ref10.get('name') : void 0;
              }
              datacenters_with_issues.push({
  ...
  this.ClusterStatusReachability = (function(_super) {
    ...
    function ClusterStatusReachability() {
      ...
      this.render = __bind(this.render, this);
      this.compute_data = __bind(this.compute_data, this);
      this.initialize = __bind(this.initialize, this);      _ref7 = ClusterStatusReachability.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
    ...
    ClusterStatusReachability.prototype.compute_data = function() {
      var data, machine, machine_id, machines_down, machines_down_array, _i, _j, _len, _len1, _ref8, _ref9;
  ...
  this.ClusterStatusConsistency = (function(_super) {
    ...
    function ClusterStatusConsistency() {
      ...
      this.render = __bind(this.render, this);
      this.compute_data = __bind(this.compute_data, this);
      this.initialize = __bind(this.initialize, this);      _ref8 = ClusterStatusConsistency.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
    ...
    ClusterStatusConsistency.prototype.compute_data = function() {
      var conflict, conflicts, issue, name, num_types_conflicts, type, types, _i, _j, _len, _len1, _ref9;
  ...
  return this.Logs = (function(_super) {
    ...
    function Logs() {
      ...
      this.fetch_log = __bind(this.fetch_log, this);      _ref9 = Logs.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
    ...
    Logs.prototype.initialize = function() {
      this.fetch_log();
      this.set_interval = setInterval(this.fetch_log, this.interval_update_log);
    ...
    Logs.prototype.set_log_entries = function(response) {
      var data, entry, i, machine_id, need_render, new_log_entry, old_log_entry, _i, _j, _len, _len1, _ref10;
      ...
      for (machine_id in response) {
        ...
        for (_i = 0, _len = data.length; _i < _len; _i++) {
          ...
          _ref10 = this.log_entries;
          for (i = _j = 0, _len1 = _ref10.length; _j < _len1; i = ++_j) {
            old_log_entry = _ref10[i];
...
module('DataExplorerView', function() {
  ...
  this.Container = (function(_super) {
    ...
    function Container() {
      ...
      this.get_result_callback = __bind(this.get_result_callback, this);
      ...
      this.start_resize_history = __bind(this.start_resize_history, this);      _ref4 = Container.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
    ...
    Container.prototype.set_doc_description = function(command, tag, suggestions) {
      var full_tag, parent, parents, _i, _len, _ref5, _ref6, _ref7, _ref8;
      ...
      if (tag === 'run') {
        ...
        this.descriptions[full_tag] = {
          ...
          description: this.description_with_example_template({
            ...
            examples: ((_ref5 = command['langs']['js']['examples']) != null ? _ref5.length : void 0) > 1 ? command['langs']['js']['examples'].slice(0, 1) : command['langs']['js']['examples']
          })
        };
      } else {
        if (command['langs']['js']['dont_need_parenthesis'] === true) {
          full_tag = tag;
        } else {
          full_tag = tag + '(';
        }
        this.descriptions[full_tag] = {
          ...
          args: (command['langs']['js']['dont_need_parenthesis'] !== true ? '( ' + command['langs']['js']['body'] + ' )' : void 0),
          description: this.description_with_example_template({
            description: command['description'],
            examples: ((_ref6 = command['langs']['js']['examples']) != null ? _ref6.length : void 0) > 1 ? command['langs']['js']['examples'].slice(0, 1) : command['langs']['js']['examples']
          })
        };
      }
      if (command['parent'] != null) {
        parents = (_ref7 = command['parent']) != null ? _ref7.split(' | ') : void 0;
      } else {
        parents = [null];
      }
      if (parents != null) {
      ...
      return this.map_state[full_tag] = (_ref8 = command['returns']) != null ? _ref8.split(' | ') : void 0;
    };
    ...
    Container.prototype.set_docs = function(data) {
      var command, done, element, group, index, new_command, parent, relations, state, suggestion, tag, _i, _j, _k, _len, _len1, _len2, _ref5, _ref6, _ref7;

      _ref5 = data['sections'];
      for (_i = 0, _len = _ref5.length; _i < _len; _i++) {
        group = _ref5[_i];
        _ref6 = group['commands'];
        for (_j = 0, _len1 = _ref6.length; _j < _len1; _j++) {
          command = _ref6[_j];
          ...
          if (tag === 'row') {
            ...
            this.set_doc_description(new_command, tag, this.suggestions);
          }
          if (tag === '()') {
            tag = '';
          }
      ...
      while (done === false) {
        ...
        for (element in relations) {
          if (this.suggestions[element] == null) {
            this.suggestions[element] = [];
          }
          if (relations[element]['parents'] != null) {
            done = false;
            index = 0;
            while (index < relations[element]['parents'].length) {
              parent = relations[element]['parents'][index];
              if (relations[parent]['parents'] == null) {
                if (this.suggestions[parent] != null) {
                  _ref7 = this.suggestions[parent];
                  for (_k = 0, _len2 = _ref7.length; _k < _len2; _k++) {
                    suggestion = _ref7[_k];
                    this.suggestions[element].push(suggestion);
                  }
                }
            ...
            if (relations[element]['parents'].length === 0) {
    ...
    Container.prototype.initialize = function(args) {
      ...
      if (((_ref5 = window.localStorage) != null ? _ref5.options : void 0) != null) {
      ...
      if (DataExplorerView.Container.prototype.history == null) {
        if (((_ref6 = window.localStorage) != null ? _ref6.rethinkdb_history : void 0) != null) {
          try {
    ...
    Container.prototype.render = function() {
      ...
      if ((((_ref5 = this.saved_data) != null ? _ref5.query : void 0) != null) && (((_ref6 = this.saved_data) != null ? _ref6.results : void 0) != null) && (((_ref7 = this.saved_data) != null ? _ref7.metadata : void 0) != null)) {
    ...
    Container.prototype.pair_char = function(event, stack) {
      ...
      if ((event != null ? event.which : void 0) != null) {
        ...
        char_to_insert = String.fromCharCode(event.which);
        if ((char_to_insert != null) && event.which !== 91) {
    ...
    Container.prototype.handle_keypress = function(editor, event) {
      ...
      if ((event != null ? event.which : void 0) != null) {
        ...
        if (event.which === 27 || (event.type === 'keydown' && ((event.ctrlKey === true || event.metaKey === true) && event.which === 32) && (this.$('.suggestion_description').css('display') !== 'none' || this.$('.suggestion_name_list').css('display') !== 'none'))) {
          ...
          if (((_ref5 = result.suggestions) != null ? _ref5.length : void 0) > 0) {
            _ref6 = result.suggestions;
          ...
          if (event.type !== 'keydown') {
            ...
            if (((_ref7 = this.current_suggestions) != null ? _ref7.length : void 0) > 0) {
              if (this.$('.suggestion_name_list').css('display') === 'none') {
                ...
                if (cached_query !== this.codemirror.getValue()) {
                  ...
                  _ref8 = this.current_suggestions;
                  for (index = _j = 0, _len1 = _ref8.length; _j < _len1; index = ++_j) {
                    suggestion = _ref8[index];
                  ...
                  if (this.current_suggestions.length > 0) {
                    this.$('.suggestion_name_list').empty();
                    _ref9 = this.current_suggestions;
                    for (i = _k = 0, _len2 = _ref9.length; _k < _len2; i = ++_k) {
                      suggestion = _ref9[i];
                      this.$('.suggestion_name_list').append(this.template_suggestion_name({
                        id: i,
                        suggestion: suggestion
              ...
              if ((this.extra_suggestions != null) && this.extra_suggestions.length > 0 && this.extra_suggestion.start_body === this.extra_suggestion.start_body) {
                if (((_ref10 = this.extra_suggestion) != null ? (_ref11 = _ref10.body) != null ? (_ref12 = _ref11[0]) != null ? _ref12.type : void 0 : void 0 : void 0) === 'string') {
                  if (this.extra_suggestion.body[0].complete === true) {
                    ...
                    _ref13 = this.extra_suggestions;
                    for (_l = 0, _len3 = _ref13.length; _l < _len3; _l++) {
                      suggestion = _ref13[_l];
                      if (regex.test(suggestion) === true) {
                ...
                if (this.extra_suggestions.length > 0) {
                  ...
                  if (((_ref14 = this.extra_suggestion.body) != null ? (_ref15 = _ref14[0]) != null ? _ref15.name.length : void 0 : void 0) != null) {
      ...
      if (this.history_displayed_id !== 0 && (event != null)) {
        if (event.ctrlKey || event.shiftKey || event.altKey || event.which === 16 || event.which === 17 || event.which === 18 || event.which === 20 || event.which === 91 || event.which === 92 || event.type in this.mouse_type_event) {
          return false;
        }
      }
      if ((event != null) && (event.which === 16 || event.which === 17 || event.which === 18 || event.which === 20 || event.which === 91 || event.which === 92)) {
        return false;
      }
      ...
      if (result_non_white_char_after_cursor !== null && !(((_ref16 = result_non_white_char_after_cursor[1]) != null ? _ref16[0] : void 0) in this.char_breakers)) {
      ...
      if (((_ref17 = result.suggestions) != null ? _ref17.length : void 0) > 0) {
        _ref18 = result.suggestions;
        for (i = _m = 0, _len4 = _ref18.length; _m < _len4; i = ++_m) {
          suggestion = _ref18[i];
          this.current_suggestions.push(suggestion);
          this.$('.suggestion_name_list').append(this.template_suggestion_name({
            id: i,
          ...
          if (element.type === null) {
            if (start === i) {
              ...
              if (result_regex !== null) {
                ...
                list_args = (_ref5 = result_regex[2]) != null ? _ref5.split(',') : void 0;
              ...
              if (result_regex !== null) {
                if (((_ref6 = stack[stack.length - 1]) != null ? _ref6.type : void 0) === 'function' || ((_ref7 = stack[stack.length - 1]) != null ? _ref7.type : void 0) === 'var') {
    ...
    Container.prototype.create_suggestion = function(args) {
      var element, hash_suggestions, i, query, result, stack, state, suggestion, _i, _j, _k, _l, _len, _len1, _len2, _len3, _m, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref20, _ref21, _ref5, _ref6, _ref7, _ref8, _ref9, _results;
      ...
      _results = [];
      for (i = _j = _ref6 = stack.length - 1; _j >= 0; i = _j += -1) {
        element = stack[i];
        ...
        if (result.status === null) {
          if (element.complete === true) {
            if (element.type === 'function') {
              if (element.complete === true || element.name === '') {
                ...
                if (((_ref7 = element.body) != null ? (_ref8 = _ref7[0]) != null ? (_ref9 = _ref8.name) != null ? _ref9.length : void 0 : void 0 : void 0) != null) {
            ...
            if (element.type === 'function') {
              if (element.body != null) {
                ...
                if (((_ref10 = element.body) != null ? (_ref11 = _ref10[0]) != null ? (_ref12 = _ref11.name) != null ? _ref12.length : void 0 : void 0 : void 0) != null) {
                  this.cursor_for_auto_completion.ch -= element.body[0].name.length;
                  this.current_extra_suggestion = element.body[0].name;
                }
                result.status = 'done';
          ...
          if (element.type === 'function') {
            ...
            if (((_ref13 = element.body) != null ? (_ref14 = _ref13[0]) != null ? (_ref15 = _ref14.name) != null ? _ref15.length : void 0 : void 0 : void 0) != null) {
              this.cursor_for_auto_completion.ch -= element.body[0].name.length;
              this.current_extra_suggestion = element.body[0].name;
            }
            result.suggestions = null;
        ...
        if (result.status === 'break_and_look_for_description') {
          if (element.type === 'function' && element.complete === false && element.name.indexOf('(') !== -1) {
            ...
            if (((_ref16 = element.body) != null ? (_ref17 = _ref16[0]) != null ? (_ref18 = _ref17.name) != null ? _ref18.length : void 0 : void 0 : void 0) != null) {
              this.cursor_for_auto_completion.ch -= element.body[0].name.length;
              this.current_extra_suggestion = element.body[0].name;
            }
            result.suggestions = null;
          ...
          if (element.type === 'function' && element.complete === true) {
            ...
            if (this.map_state[element.name]) {
              hash_suggestions = {};
              _ref19 = this.map_state[element.name];
              for (_k = 0, _len1 = _ref19.length; _k < _len1; _k++) {
                state = _ref19[_k];
                if (this.suggestions[state] != null) {
                  _ref20 = this.suggestions[state];
                  for (_l = 0, _len2 = _ref20.length; _l < _len2; _l++) {
                    suggestion = _ref20[_l];
              ...
              for (suggestion in hash_suggestions) {
                result.suggestions.push(suggestion);
              }
            }
            _results.push(result.status = 'done');
            ...
            if (this.suggestions[result.state] != null) {
              _ref21 = this.suggestions[result.state];
              for (_m = 0, _len3 = _ref21.length; _m < _len3; _m++) {
                suggestion = _ref21[_m];
                if (result.suggestions_regex.test(suggestion) === true) {
                  result.suggestions.push(suggestion);
                }
              }
    ...
    Container.prototype.create_safe_regex = function(str) {
      var char, _i, _len, _ref5;

      _ref5 = this.unsafe_to_safe_regexstr;
      for (_i = 0, _len = _ref5.length; _i < _len; _i++) {
        char = _ref5[_i];
    ...
    Container.prototype.extend_description = function(fn) {
      var data, database_used, databases_available, description, namespace, namespaces_available, _i, _len, _ref5, _ref6, _ref7;

      if ((((_ref5 = this.options) != null ? _ref5.can_extend : void 0) != null) && ((_ref6 = this.options) != null ? _ref6.can_extend : void 0) === false) {
    ...
    Container.prototype.extract_database_used = function() {
      var arg, char, database, database_test_id, db_name, end_arg_position, last_db_position, query_before_cursor, _i, _j, _len, _len1, _ref5, _ref6;
    ...
    Container.prototype.execute_query = function() {
      ...
      this.query = this.replace_new_lines_in_query(this.raw_query);
      try {
    ...
    Container.prototype.execute_portion = function() {
      ...
      while (this.queries[this.index] != null) {
        ...
        if (rdb_query instanceof TermBase) {
          ...
          rdb_query.private_run(this.driver_handler.connection, rdb_global_callback);
          return true;
          ...
          if (_this.index === _this.queries.length) {
            ...
            if ((cursor != null ? cursor.hasNext : void 0) != null) {
              ...
              _this.saved_data.metadata = {
                limit_value: ((_ref5 = _this.current_results) != null ? _ref5.length : void 0) != null ? _this.current_results.length : 1,
    ...
    Container.prototype.get_result_callback = function(error, data) {
      if (error != null) {
        this.results_view.render_error(this.query, error);
        this.save_query({
          query: this.raw_query,
          broken_query: true
        });
      ...
      if (data !== void 0) {
        ...
        if (this.current_results.length < this.limit && this.cursor.hasNext() === true) {
          this.cursor.next(this.get_result_callback);
          return true;
        }
      }
      this.saved_data.cursor = this.cursor;
      this.saved_data.query = this.query;
      this.saved_data.results = this.current_results;
      this.saved_data.metadata = {
        limit_value: this.current_results.length,
        skip_value: this.skip_value,
        execution_time: new Date() - this.start_time,
        query: this.query,
        has_more_data: this.cursor.hasNext()
      };
      this.results_view.render_result({
        results: this.current_results,
        metadata: this.saved_data.metadata
      });
      this.save_query({
        query: this.raw_query,
    ...
    Container.prototype.evaluate = function(query) {
      "use strict";      return eval(query);
    };

    Container.prototype.replace_new_lines_in_query = function(query) {
  ...
  this.ResultView = (function(_super) {
    ...
    function ResultView() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref5 = ResultView.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
    ...
    */
    ...
    ResultView.prototype.compute_occurrence = function(keys_count) {
      var count_key, count_occurrence, key, row, _ref6;
    ...
    ResultView.prototype.json_to_table = function(result) {
      ...
      if (!((result.constructor != null) && result.constructor === ArrayResult)) {
        result = [result];
      }
      keys_count = {
        primitive_value_count: 0
    ...
    ResultView.prototype.get_all_attr = function(args) {
      var attr, key, keys_count, new_prefix, new_prefix_str, prefix, prefix_str, _i, _len, _ref6, _results;

      keys_count = args.keys_count;
      attr = args.attr;
      prefix = args.prefix;
      prefix_str = args.prefix_str;
      _ref6 = keys_count.sorted_keys;
      _results = [];
      for (_i = 0, _len = _ref6.length; _i < _len; _i++) {
        key = _ref6[_i];
    ...
    ResultView.prototype.json_to_table_get_values = function(args) {
      var attr_obj, col, document_list, flatten_attr, i, key, new_document, prefix, result, single_result, value, _i, _j, _k, _len, _len1, _len2, _ref6;
    ...
    ResultView.prototype.compute_data_for_type = function(value, col) {
      ...
      } else if ((value.constructor != null) && value.constructor === ArrayResult) {
        if (value.length === 0) {
          data['value'] = '[ ]';
    ...
    ResultView.prototype.handle_mousedown = function(event) {
      ...
      if ((event != null ? (_ref6 = event.target) != null ? _ref6.className : void 0 : void 0) === 'click_detector') {
    ...
    ResultView.prototype.render_result = function(args) {
      var col, column, current_size, expandable_columns, extra_size_table, index, keys, max_size, minutes, num_results, previous_keys, real_size, same_keys, value, _i, _j, _k, _len, _len1, _ref10, _ref11, _ref6, _ref7, _ref8, _ref9;
      ...
      if ((args != null ? (_ref6 = args.metadata) != null ? _ref6.skip_value : void 0 : void 0) != null) {
      ...
      if (this.metadata.has_more_data !== true) {
        if (((_ref7 = this.results) != null ? _ref7.length : void 0) != null) {
      ...
      this.$el.html(this.template(_.extend(this.metadata, {
        ...
        no_results: this.metadata.has_more_data !== true && ((_ref8 = this.results) != null ? _ref8.length : void 0) === 0 && this.metadata.skip_value === 0,
      ...
      switch (this.view) {
        ...
        case 'table':
          ...
          if (this.last_keys.length !== previous_keys.length) {
            ...
            same_keys = true;
            _ref9 = this.last_keys;
            for (index = _i = 0, _len = _ref9.length; _i < _len; index = ++_i) {
              keys = _ref9[index];
          ...
          if (extra_size_table > 0) {
            expandable_columns = [];
            for (index = _j = 0, _ref11 = this.last_keys.length - 1; 0 <= _ref11 ? _j <= _ref11 : _j >= _ref11; index = 0 <= _ref11 ? ++_j : --_j) {
              real_size = 0;
    ...
    ResultView.prototype.cursor_timed_out = function() {
      ...
      if (((_ref6 = this.container.saved_data.metadata) != null ? _ref6.has_more_data : void 0) === true) {
  ...
  this.OptionsView = (function(_super) {
    ...
    function OptionsView() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref6 = OptionsView.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  this.HistoryView = (function(_super) {
    ...
    function HistoryView() {
      ...
      this.handle_mouseup = __bind(this.handle_mouseup, this);
      this.handle_mousemove = __bind(this.handle_mousemove, this);
      this.start_resize = __bind(this.start_resize, this);      _ref7 = HistoryView.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
  ...
  return this.DriverHandler = (function() {
    ...
    DriverHandler.prototype.hack_driver = function() {
      ...
      if (TermBase.prototype.private_run == null) {
        that = this;
        TermBase.prototype.private_run = TermBase.prototype.run;
        return TermBase.prototype.run = function() {
      ...
      try {
        r.connect(this.server, function(err, connection) {
          if (err != null) {
            ...
            return that.on_success(connection);
          }
        });
        if (this.container != null) {
...
module('Sidebar', function() {
  ...
  this.ClientConnectionStatus = (function(_super) {
    ...
    function ClientConnectionStatus() {
      this.destroy = __bind(this.destroy, this);
      this.render = __bind(this.render, this);
      this.initialize = __bind(this.initialize, this);      _ref5 = ClientConnectionStatus.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  this.ServersConnected = (function(_super) {
    ...
    function ServersConnected() {
      this.destroy = __bind(this.destroy, this);
      this.render = __bind(this.render, this);
      this.initialize = __bind(this.initialize, this);      _ref6 = ServersConnected.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
    ...
    ServersConnected.prototype.render = function() {
      var data, data_in_json, machine, servers_active, _i, _len, _ref7;

      servers_active = 0;
      _ref7 = directory.models;
      for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
        machine = _ref7[_i];
        if (directory.get(machine.get('id')) != null) {
          servers_active++;
  ...
  this.DatacentersConnected = (function(_super) {
    ...
    function DatacentersConnected() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref7 = DatacentersConnected.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
  ...
  this.Issues = (function(_super) {
    ...
    function Issues() {
      this.destroy = __bind(this.destroy, this);
      this.render = __bind(this.render, this);
      this.initialize = __bind(this.initialize, this);      _ref8 = Issues.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  return this.IssuesBanner = (function(_super) {
    ...
    function IssuesBanner() {
      ...
      this.render = __bind(this.render, this);
      this.initialize = __bind(this.initialize, this);      _ref9 = IssuesBanner.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
...
module('ResolveIssuesView', function() {
  ...
  this.Container = (function(_super) {
    ...
    function Container() {
      this.render = __bind(this.render, this);      _ref4 = Container.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  this.IssueList = (function(_super) {
    ...
    function IssueList() {
      _ref5 = IssueList.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  this.DeclareMachineDeadModal = (function(_super) {
    ...
    function DeclareMachineDeadModal() {
      this.on_success_with_error = __bind(this.on_success_with_error, this);      _ref6 = DeclareMachineDeadModal.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
    ...
    DeclareMachineDeadModal.prototype.on_success = function(response) {
      var blueprint, namespace, _i, _len, _ref7;
  ...
  this.ResolveNameConflictModal = (function(_super) {
    ...
    function ResolveNameConflictModal() {
      ...
      this.render = __bind(this.render, this);      _ref7 = ResolveNameConflictModal.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
  ...
  this.ResolveVClockModal = (function(_super) {
    ...
    function ResolveVClockModal() {
      _ref8 = ResolveVClockModal.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
    ...
    ResolveVClockModal.prototype.on_submit = function() {
      ...
      return $.ajax({
        url: "/ajax/semilattice/" + this.resolution_url,
        type: 'POST',
        contentType: 'application/json',
  ...
  this.ResolveUnsatisfiableGoal = (function(_super) {
    ...
    function ResolveUnsatisfiableGoal() {
      _ref9 = ResolveUnsatisfiableGoal.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
    ...
    ResolveUnsatisfiableGoal.prototype.on_submit = function() {
      var ack_expectations_to_send, datacenter, replica_affinities_to_send, _i, _len, _ref10;

      ResolveUnsatisfiableGoal.__super__.on_submit.apply(this, arguments);
      replica_affinities_to_send = {};
      ack_expectations_to_send = {};
      _ref10 = this.datacenters_with_issues;
      for (_i = 0, _len = _ref10.length; _i < _len; _i++) {
        datacenter = _ref10[_i];
  ...
  return this.Issue = (function(_super) {
    ...
    function Issue() {
      this.render_machine_down = __bind(this.render_machine_down, this);      _ref10 = Issue.__super__.constructor.apply(this, arguments);
      return _ref10;
    }
    ...
    Issue.prototype.render_machine_down = function(_template) {
      ...
      replicas = [];
      namespaces.each(function(namespace) {
        var machine_uuid, role, role_summary, shard, _ref11, _results;

        _ref11 = namespace.get('blueprint').peers_roles;
        _results = [];
        for (machine_uuid in _ref11) {
          role_summary = _ref11[machine_uuid];
    ...
    Issue.prototype.render_vclock_conflict = function(_template) {
      ...
      get_resolution_url = function() {
        if (_this.model.get('object_type') === 'namespace') {
          return 'rdb_' + _this.model.get('object_type') + 's/' + _this.model.get('object_id') + '/' + _this.model.get('field') + '/resolve';
        } else {
          return _this.model.get('object_type') + 's/' + _this.model.get('object_id') + '/' + _this.model.get('field') + '/resolve';
        }
      };
          ...
          if (num_active_datacenters === 1) {
            ...
            for (datacenter_id in this.model.get('replica_affinities')) {
              ...
              if (num_replicas_requested > 0 && this.model.get('actual_machines_in_datacenters')[datacenter_id] > 0 && (datacenters.get(datacenter_id) != null) && datacenter_id !== universe_datacenter.get('id')) {
                datacenter_name = (_ref12 = datacenters.get(datacenter_id)) != null ? _ref12.get('name') : void 0;
...
module('LogView', function() {
  ...
  this.Container = (function(_super) {
    ...
    Container.prototype.parse_log = function(log_data_from_server) {
      var attribute, entry, i, is_same_log, json, log, log_entries, log_saved, machine_uuid, view, _i, _j, _k, _l, _len, _len1, _len2, _ref5, _ref6, _ref7;
      ...
      if (this.current_logs.length <= this.displayed_logs) {
        ...
        for (i = _l = 0, _ref7 = this.max_log_entries - 1; 0 <= _ref7 ? _l <= _ref7 : _l >= _ref7; i = 0 <= _ref7 ? ++_l : --_l) {
    ...
    Container.prototype.check_for_new_updates = function() {
      var min_timestamp, route, _ref5,
        _this = this;

      min_timestamp = (_ref5 = this.current_logs[0]) != null ? _ref5.get('timestamp') : void 0;
    ...
    Container.prototype.render_header = function() {
      ...
      return this.$('.header').html(this.header_template({
        ...
        from_date: new XDate(((_ref5 = this.current_logs[0]) != null ? _ref5.get('timestamp') : void 0) * 1000).toString("MMMM M, yyyy 'at' HH:mm:ss"),
        to_date: new XDate(((_ref6 = this.current_logs[this.displayed_logs - 1]) != null ? _ref6.get('timestamp') : void 0) * 1000).toString("MMMM M, yyyy 'at' HH:mm:ss"),
        logs_for: {
    ...
    Container.prototype.parse_new_log = function(log_data_from_server) {
      var entry, i, json, log, log_entries, log_saved, machine_uuid, rendered_view, view, _i, _j, _k, _len, _len1, _ref5, _ref6;
      ...
      for (i = _k = _ref6 = this.num_new_entries - 1; _ref6 <= 0 ? _k <= 0 : _k >= 0; i = _ref6 <= 0 ? ++_k : --_k) {
        view = new LogView.LogEntry({
  ...
  return this.LogEntry = (function(_super) {
    ...
    function LogEntry() {
      ...
      this.render = __bind(this.render, this);
      this.display_details = __bind(this.display_details, this);      _ref5 = LogEntry.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
    ...
    LogEntry.prototype.format_msg = function(model) {
      var attribute, attributes, data, database_id, datacenter_id, datacenter_name, group, json_data, machine_id, msg, namespace_id, raw_data, shard, shard_string, shards, value, _datacenters, _i, _j, _len, _len1, _machines, _ref6, _ref7, _ref8;
                  ...
                  for (attribute in json_data[group][namespace_id]) {
                    if (attribute === 'ack_expectations' || attribute === 'replica_affinities') {
                      ...
                      for (datacenter_id in json_data[group][namespace_id][attribute]) {
                        if (datacenter_id === universe_datacenter.get('id')) {
                          datacenter_name = universe_datacenter.get('name');
                        } else if (((_ref6 = datacenters.get(datacenter_id)) != null ? _ref6.get('name') : void 0) != null) {
                          datacenter_name = datacenters.get(datacenter_id).get('name');
                        } else {
                          datacenter_name = 'a removed datacenter';
                        }
                      ...
                      for (shard in json_data[group][namespace_id][attribute]) {
                        _machines = [];
                        _ref7 = json_data[group][namespace_id][attribute][shard];
                        for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
                          machine_id = _ref7[_i];
                          if (machine_id != null) {
                            _machines.push({
                      ...
                      value = [];
                      _ref8 = json_data[group][namespace_id][attribute];
                      for (_j = 0, _len1 = _ref8.length; _j < _len1; _j++) {
                        shard_string = _ref8[_j];
...
module('Vis', function() {
  ...
  this.OpsPlotLegend = (function(_super) {
    ...
    function OpsPlotLegend() {
      this.destroy = __bind(this.destroy, this);
      this.initialize = __bind(this.initialize, this);      _ref4 = OpsPlotLegend.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  this.OpsPlot = (function(_super) {
    ...
    function OpsPlot() {
      this.destroy = __bind(this.destroy, this);
      this.render = __bind(this.render, this);
      this.make_metric = __bind(this.make_metric, this);      _ref5 = OpsPlot.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  this.SizeBoundedCache = (function() {
    ...
    SizeBoundedCache.prototype.push = function(stats) {
      ...
      if (this.values.length < this.ndp) {
        for (i = _i = _ref6 = this.values.length, _ref7 = this.ndp - 1; _ref6 <= _ref7 ? _i < _ref7 : _i > _ref7; i = _ref6 <= _ref7 ? ++_i : --_i) {
          this.values.push(value);
        }
      }
      if (this.values.length > this.ndp) {
  ...
  return this.InterpolatingCache = (function() {
    function InterpolatingCache(num_data_points, num_interpolation_points, get_data_fn) {
      ...
      this.values = [];
      for (i = _i = 0, _ref6 = this.ndp - 1; 0 <= _ref6 ? _i <= _ref6 : _i >= _ref6; i = 0 <= _ref6 ? ++_i : --_i) {
        this.values.push(0);
      }
...
Database = (function(_super) {
  ...
  function Database() {
    ...
    this.get_namespaces = __bind(this.get_namespaces, this);    _ref4 = Database.__super__.constructor.apply(this, arguments);
    return _ref4;
  }

  Database.prototype.get_namespaces = function() {
    var namespace, namespaces_in_datacenter, _i, _len, _ref5;

    namespaces_in_datacenter = [];
    _ref5 = namespaces.models;
    for (_i = 0, _len = _ref5.length; _i < _len; _i++) {
      namespace = _ref5[_i];
  ...
  Database.prototype.get_stats_for_performance = function() {
    var namespace, __s, _i, _len, _ref5, _s;
...
Namespace = (function(_super) {
  ...
  function Namespace() {
    ...
    this.compute_shards = __bind(this.compute_shards, this);    _ref5 = Namespace.__super__.constructor.apply(this, arguments);
    return _ref5;
  }
  ...
  Namespace.prototype.transform_key = function(a) {
    ...
    if (a === null) {
      ...
      a_new = -Infinity;
    } else if (typeof a === "string" && (a[0] != null) && a[0] === 'N') {
      s = a.slice(a.indexOf("%23") + 3);
      if (_.isNaN(parseFloat(s)) === false) {
        a_new = parseFloat(s);
      }
    } else if (typeof a === "string" && (a[0] != null) && a[0] === 'S') {
      a_new = a.slice(1);
    }
    return a_new;
  };
  ...
  Namespace.prototype.compare_keys = function(a, b) {
    ...
    if (typeof a_new === 'number' && typeof b_new === 'number') {
      return a_new - b_new;
    } else if (typeof a_new === 'string' && typeof b_new === 'string') {
      if (a_new > b_new) {
        return 1;
      } else if (a_new < b_new) {
        return -1;
  ...
  Namespace.prototype.compute_shard_rows_approximation = function(shard) {
    var count, end_key, key, start_key, _i, _len, _ref6;
    ...
    end_key = shard[1];
    count = 0;
    _ref6 = this.get('key_distr_sorted');
    for (_i = 0, _len = _ref6.length; _i < _len; _i++) {
      key = _ref6[_i];
  ...
  Namespace.prototype.get_stats_for_performance = function() {
    var machine, num_machines_in_namespace, __s, _i, _len, _ref6, _s;
  ...
  Namespace.prototype.get_durability = function() {
    ...
    if (this.get('hard_durability') != null) {
      ...
      _ref6 = this.get('ack_expectations');
      for (dc in _ref6) {
        ack = _ref6[dc];
...
Datacenter = (function(_super) {
  ...
  function Datacenter() {
    ...
    this.compute_num_machines_not_used_by_other_datacenters = __bind(this.compute_num_machines_not_used_by_other_datacenters, this);    _ref6 = Datacenter.__super__.constructor.apply(this, arguments);
    return _ref6;
  }
  ...
  Datacenter.prototype.get_stats = function() {
    var machine, stats, _i, _len, _ref7;
  ...
  Datacenter.prototype.get_stats_for_performance = function() {
    var has_data, machine, machine_id, namespace, num_machines_in_datacenter, shard_key, __s, _i, _j, _len, _len1, _ref7, _ref8, _s;
...
Machine = (function(_super) {
  ...
  function Machine() {
    ...
    this.get_stats = __bind(this.get_stats, this);    _ref7 = Machine.__super__.constructor.apply(this, arguments);
    return _ref7;
  }
  ...
  Machine.prototype.get_used_disk_space = function() {
    var machine_disk_space, nid, stats, value, _ref8;

    machine_disk_space = 0;
    _ref8 = this.get_stats();
    for (nid in _ref8) {
      value = _ref8[nid];
  ...
  Machine.prototype.get_stats_for_performance = function() {
    var namespace, stats_full, __s, _i, _len, _ref8, _s;
  ...
  Machine.prototype.is_master_for_namespaces = function() {
    ...
    return namespaces.filter(function(namespace) {
      var machine_uuid, peer_roles, role, shard, _ref8;

      _ref8 = namespace.get('blueprint').peers_roles;
      for (machine_uuid in _ref8) {
        peer_roles = _ref8[machine_uuid];
  ...
  Machine.prototype.get_data_for_moving = function() {
    var data, dc_uuid, namespace, namespaces_with_critical_issue, namespaces_with_unsatisfiable_goals, num_machines_in_dc, num_replicas, _i, _len, _ref8,
      _this = this;
...
LogEntry = (function(_super) {
  ...
  function LogEntry() {
    ...
    this.get_iso_8601_timestamp = __bind(this.get_iso_8601_timestamp, this);    _ref8 = LogEntry.__super__.constructor.apply(this, arguments);
    return _ref8;
  }
...
Issue = (function(_super) {
  ...
  function Issue() {
    _ref9 = Issue.__super__.constructor.apply(this, arguments);
    return _ref9;
  }
...
IssueRedundancy = (function(_super) {
  ...
  function IssueRedundancy() {
    _ref10 = IssueRedundancy.__super__.constructor.apply(this, arguments);
    return _ref10;
  }
...
Progress = (function(_super) {
  ...
  function Progress() {
    _ref11 = Progress.__super__.constructor.apply(this, arguments);
    return _ref11;
  }
...
MachineAttributes = (function(_super) {
  ...
  function MachineAttributes() {
    _ref12 = MachineAttributes.__super__.constructor.apply(this, arguments);
    return _ref12;
  }
...
ConnectionStatus = (function(_super) {
  ...
  function ConnectionStatus() {
    _ref13 = ConnectionStatus.__super__.constructor.apply(this, arguments);
    return _ref13;
  }
...
ComputedCluster = (function(_super) {
  ...
  function ComputedCluster() {
    this.get_stats = __bind(this.get_stats, this);    _ref14 = ComputedCluster.__super__.constructor.apply(this, arguments);
    return _ref14;
  }
  ...
  ComputedCluster.prototype.get_stats = function() {
    var m, namespace, __s, _i, _j, _len, _len1, _ref15, _ref16, _s;
...
Databases = (function(_super) {
  ...
  function Databases() {
    _ref15 = Databases.__super__.constructor.apply(this, arguments);
    return _ref15;
  }
...
Namespaces = (function(_super) {
  ...
  function Namespaces() {
    _ref16 = Namespaces.__super__.constructor.apply(this, arguments);
    return _ref16;
  }
...
Datacenters = (function(_super) {
  ...
  function Datacenters() {
    _ref17 = Datacenters.__super__.constructor.apply(this, arguments);
    return _ref17;
  }
...
Machines = (function(_super) {
  ...
  function Machines() {
    _ref18 = Machines.__super__.constructor.apply(this, arguments);
    return _ref18;
  }
...
Issues = (function(_super) {
  ...
  function Issues() {
    _ref19 = Issues.__super__.constructor.apply(this, arguments);
    return _ref19;
  }
...
IssuesRedundancy = (function(_super) {
  ...
  function IssuesRedundancy() {
    this.compute_redundancy_errors = __bind(this.compute_redundancy_errors, this);    _ref20 = IssuesRedundancy.__super__.constructor.apply(this, arguments);
    return _ref20;
  }
  ...
  IssuesRedundancy.prototype.compute_redundancy_errors = function() {
    var blueprint, directory_by_namespaces, issue_redundancy, issue_redundancy_param, issues_redundancy_new, key, machine_id, machine_name, namespace, namespace_id, num_replicas, value, _i, _len, _ref21;

    issues_redundancy_new = [];
    num_replicas = 0;
    directory_by_namespaces = DataUtils.get_directory_activities_by_namespaces();
    _ref21 = namespaces.models;
...
ProgressList = (function(_super) {
  ...
  function ProgressList() {
    _ref21 = ProgressList.__super__.constructor.apply(this, arguments);
    return _ref21;
  }
...
Directory = (function(_super) {
  ...
  function Directory() {
    _ref22 = Directory.__super__.constructor.apply(this, arguments);
    return _ref22;
  }
...
module('DataUtils', function() {
  ...
  this.Shard = (function(_super) {
    ...
    function Shard() {
      ...
      this.get_primary_uuid = __bind(this.get_primary_uuid, this);      _ref23 = Shard.__super__.constructor.apply(this, arguments);
      return _ref23;
    }
  ...
  this.Shards = (function(_super) {
    ...
    function Shards() {
      ...
      this.initialize = __bind(this.initialize, this);      _ref24 = Shards.__super__.constructor.apply(this, arguments);
      return _ref24;
    }
  ...
  this.get_datacenter_reachability = function(datacenter_uuid) {
    var json, last_seen, machine, reachable, total, _i, _last_seen, _len, _ref25,
      _this = this;
  ...
  this.get_shard_primary_uuid = function(namespace_uuid, shard) {
    var machine_uuid, peers_roles, role, _ref25, _shard;

    _ref25 = namespaces.get(namespace_uuid).get('blueprint').peers_roles;
    for (machine_uuid in _ref25) {
      peers_roles = _ref25[machine_uuid];
  ...
  this.get_shard_secondary_uuids = function(namespace_uuid, shard) {
    var datacenter_uuid, machine_uuid, peers_roles, role, secondaries, _ref25, _shard;
  ...
  this.get_ack_expectations = function(namespace_uuid, datacenter_uuid) {
    var acks, namespace, _ref25, _ref26;

    namespace = namespaces.get(namespace_uuid);
    acks = namespace != null ? (_ref25 = namespace.get('ack_expectations')) != null ? (_ref26 = _ref25[datacenter_uuid]) != null ? _ref26.expectation : void 0 : void 0 : void 0;
    if (acks != null) {
      return acks;
    } else {
      return 0;
  ...
  this.get_replica_affinities = function(namespace_uuid, datacenter_uuid) {
    var affs, datacenter, namespace, _ref25;
    ...
    affs = namespace != null ? (_ref25 = namespace.get('replica_affinities')) != null ? _ref25[datacenter != null ? datacenter.get('id') : void 0] : void 0 : void 0;
    if (affs != null) {
      return affs;
    } else {
      return 0;
  ...
  this.get_directory_activities = function() {
    var activities, activity, activity_id, activity_map, bcards, machine, namespace_id, _i, _len, _ref25;

    activities = {};
    _ref25 = directory.models;
    for (_i = 0, _len = _ref25.length; _i < _len; _i++) {
      machine = _ref25[_i];
  ...
  this.get_backfill_progress = function(namespace_uuid, shard, machine_uuid) {
    var activity, activity_map, activity_type, activity_uuid, agg_json, agg_start, backfiller, i, into_shard, json, output_json, progress, progress_info, progress_info_arr, ratio_available, sender, senders_activity_id, shard_map, union_shard, _i, _j, _len, _output_json, _pia, _ref25, _ref26, _us;
    ...
    for (activity_uuid in progress) {
      ...
      if (activity_type === 'secondary_backfilling') {
        ...
        _ref25 = activity.value[1].backfillers;
        for (_i = 0, _len = _ref25.length; _i < _len; _i++) {
          backfiller = _ref25[_i];
      ...
      for (i = _j = 0, _ref26 = progress_info_arr.length - 1; 0 <= _ref26 ? _j <= _ref26 : _j >= _ref26; i = 0 <= _ref26 ? ++_j : --_j) {
  ...
  this.get_backfill_progress_agg = function(namespace_uuid, datacenter_uuid) {
    var agg_json, agg_start, backfills, datacenter_machines, machine_uuid, machines, namespace_machines, output_json, shard, _i, _j, _len, _len1, _ref25;
    ...
    for (_i = 0, _len = machines.length; _i < _len; _i++) {
      ...
      _ref25 = namespaces.get(namespace_uuid).get('shards');
  ...
  this.get_namespace_status = function(namespace_uuid, datacenter_uuid) {
    var json, machine_active_for_namespace, machine_uuid, namespace, peer_accessible, role, role_name, shard, _datacenters, _machines, _ref25, _ref26;
    ...
    _machines = [];
    _datacenters = [];
    _ref25 = namespace.get('blueprint').peers_roles;
    for (machine_uuid in _ref25) {
      role = _ref25[machine_uuid];
      if (machines.get(machine_uuid) == null) {
        continue;
      }
      if ((datacenter_uuid != null) && ((_ref26 = machines.get(machine_uuid)) != null ? _ref26.get('datacenter_uuid') : void 0) !== datacenter_uuid) {
        continue;
      }
...
NavBarView = (function(_super) {
  ...
  function NavBarView() {
    ...
    this.initialize = __bind(this.initialize, this);    _ref23 = NavBarView.__super__.constructor.apply(this, arguments);
    return _ref23;
  }
...
BackboneCluster = (function(_super) {
  ...
  function BackboneCluster() {
    this.set_stats_call = __bind(this.set_stats_call, this);    _ref24 = BackboneCluster.__super__.constructor.apply(this, arguments);
    return _ref24;
  }
...
set_stats = function(stat_data) {
  var data, machine_id, mid, _i, _len, _ref25, _ref26, _results;
  ...
  for (machine_id in stat_data) {
    ...
    if (machines.get(machine_id) != null) {
      ...
      for (_i = 0, _len = _ref25.length; _i < _len; _i++) {
        mid = _ref25[_i];
        if ((_ref26 = machines.get(mid)) != null) {
          _ref26.set('stats_up_to_date', true);
        }
      }
      _results.push((function() {
        var _j, _len1, _ref27, _ref28, _results1;

        _ref27 = data.timed_out;
        _results1 = [];
        for (_j = 0, _len1 = _ref27.length; _j < _len1; _j++) {
          mid = _ref27[_j];
          _results1.push((_ref28 = machines.get(mid)) != null ? _ref28.set('stats_up_to_date', false) : void 0);
        }
        return _results1;
      })());
      /*
